...
var POSTS = [
  {
    id:'sealstar-website-renewal', type:'notice', date:'2026-07-24', img:'images/web/company-exterior.jpg',
    placeKo:'', placeEn:'',
  ...
  {
    id:'hydrogen-sealing-rollout', type:'press', date:'2023-09-20', img:'https://cdn.gasnews.com/news/photo/202309/112043_83168_105.jpg',
    placeKo:'', placeEn:'',
...
(function(){
  ...
  function draw(){
    ...
    grid.innerHTML=list.map(function(p){
      ...
      var href = p.id ? ('news/'+p.id+'.html') : '#';
      return '<a class="ncard" href="'+href+'" onclick="NB.open('+idx+');return false;">'
        ...
        +'<div class="date"><span>'+p.date+'</span>'+place+'</div></div></a>';
    }).join('');
  }
